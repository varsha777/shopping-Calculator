...
public class PdfPopImage {

    private PdfWriter pdfWriter;

    private static ArrayList<PopModelImage> arrayListRProductModel = new ArrayList<PopModelImage>();

    public boolean createPDF(Context context, String reportName, ArrayList<PopModelImage> posModelArrayList, String locationStore) {
