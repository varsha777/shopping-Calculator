...
public class PdfPopText {

    private PdfWriter pdfWriter;

    private static ArrayList<PopModel> arrayListRProductModel = new ArrayList<PopModel>();

    public boolean createPDF(Context context, String reportName, ArrayList<PopModel> posModelArrayList, String locationStore) {
