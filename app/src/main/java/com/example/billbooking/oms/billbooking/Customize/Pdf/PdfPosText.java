...
public class PdfPosText {

    private PdfWriter pdfWriter;

    private static ArrayList<PosModel> arrayListRProductModel = new ArrayList<PosModel>();

    public boolean createPDF(Context context, String reportName, ArrayList<PosModel> posModelArrayList, String locationStore) {
