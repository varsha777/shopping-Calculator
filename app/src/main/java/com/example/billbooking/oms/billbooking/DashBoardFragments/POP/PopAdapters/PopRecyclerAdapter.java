...
public class PopRecyclerAdapter extends RecyclerView.Adapter<PopRecyclerAdapter.RecyclerItemViewHolder> {
    ...
    public PopRecyclerAdapter(ArrayList<PopModel> myList, Context context) {
        this.myList = myList;
    ...
    public RecyclerItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pop_card_items, parent, false);
                        ...
                        if ((event != null && (event.getKeyCode() == KeyEvent.KEYCODE_ENTER)) || (actionId == EditorInfo.IME_ACTION_DONE)) {
                            ...
                            if (holder.edcommodity.getText().toString().isEmpty()) {
                                ...
                                if (value == -1) {
                                    ...
                                    myList.get(position).setTotal((myList.get(position).getQuantity()) * (myList.get(position).getPrice()));
                                    value = -1;
                                }
                                holder.switcherCommodity.showNext();
