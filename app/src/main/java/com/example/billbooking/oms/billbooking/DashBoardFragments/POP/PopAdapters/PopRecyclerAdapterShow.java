...
public class PopRecyclerAdapterShow extends RecyclerView.Adapter<PopRecyclerAdapterShow.RecyclerItemViewHolder> {
    ...
    public PopRecyclerAdapterShow(ArrayList<PopModel> myList, Context context, RecyclerView res, LinearLayout linearLayout) {
        this.myList = myList;
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                if (pos >= 0 && pos < getItemCount()) {
                    ...
                    final PopModel deletedItem = myList.get(pos);
    ...
    public void onBindViewHolder(final RecyclerItemViewHolder holder, final int position) {
        ...
        this.holder = holder;
        final PopModel item = myList.get(position);
    ...
    public void restoreItem(PopModel item, int position) {
