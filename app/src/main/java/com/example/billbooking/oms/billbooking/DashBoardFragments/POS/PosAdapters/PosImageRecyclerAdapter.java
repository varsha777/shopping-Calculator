...
public class PosImageRecyclerAdapter extends RecyclerView.Adapter<PosImageRecyclerAdapter.RecyclerItemViewHolder> {
    ...
    public PosImageRecyclerAdapter(ArrayList<PosModelImage> myList, Context context) {
        this.myList = myList;
    ...
    public RecyclerItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pos_card_items_image, parent, false);
    ...
    public void onBindViewHolder(final RecyclerItemViewHolder holder, final int position) {
        ...
        holder.tvtotal.setText(String.valueOf((myList.get(position).getPrice()) * (myList.get(position).getQuantity())));
