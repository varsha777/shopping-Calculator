...
public class PosImageRecyclerAdapterShow extends RecyclerView.Adapter<PosImageRecyclerAdapterShow.RecyclerItemViewHolder> {
    private ArrayList<PosModelImage> myList;
    ...
    public PosImageRecyclerAdapterShow(ArrayList<PosModelImage> myList, Context context, RecyclerView res, LinearLayout linearLayout) {
        this.myList = myList;
    ...
    public RecyclerItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pos_card_items_show, parent, false);
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                if (pos >= 0 && pos < getItemCount()) {
                    ...
                    final PosModelImage deletedItem = myList.get(pos);
    ...
    public void onBindViewHolder(final RecyclerItemViewHolder holder, final int position) {
        ...
        this.holder = holder;
        final PosModelImage item = myList.get(position);
    ...
    public void restoreItem(PosModelImage item, int position) {
    ...
    public void notifyData(ArrayList<PosModelImage> myList) {
