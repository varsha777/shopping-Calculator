...
public class PosRecyclerAdapterShow extends RecyclerView.Adapter<PosRecyclerAdapterShow.RecyclerItemViewHolder> {
    ...
    public PosRecyclerAdapterShow(ArrayList<PosModel> myList, Context context, RecyclerView res, LinearLayout linearLayout) {
        this.myList = myList;
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                if (pos >= 0 && pos < getItemCount()) {
                    ...
                    final PosModel deletedItem = myList.get(pos);
    ...
    public void onBindViewHolder(final RecyclerItemViewHolder holder, final int position) {
        ...
        this.holder = holder;
        final PosModel item = myList.get(position);
    ...
    public void restoreItem(PosModel item, int position) {
